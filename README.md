...
- `0.14.0.0-rc5-alpine`, `0.14-rc5-alpine` ([0.14-rc5/alpine/Dockerfile](https://github.com/MindhiveCode/docker-dash-core/blob/master/0.14-rc5/alpine/Dockerfile))
- `0.14.0.0-rc5`, `0.14-rc5`  ([0.14-rc5/Dockerfile](https://github.com/MindhiveCode/docker-dash-core/blob/master/0.14-rc5/Dockerfile))
